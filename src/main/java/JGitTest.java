...
public class JGitTest {
    ...
    public String remotePath = "git@git.corp.kuaishou.com:yangyuanxi/gifshow-android.git";//远程库路径
    public String localPath = "/Users/admin/Project";//下载已有仓库到本地路径
    public String initPath = "/Users/admin/Test";//本地路径新建
