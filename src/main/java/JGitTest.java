...
public class JGitTest {
    ...
    public String remotePath = "git@github.com:MikakuU/LearnGit.git";//远程库路径
    public String localPath = "/Users/admin/localPath";//本地路径
    public String initPath = "/Users/admin/initPath";//本地路径新建
    ...
    public void testClone() throws IOException, GitAPIException {
        ...
        UsernamePasswordCredentialsProvider usernamePasswordCredentialsProvider =new
                UsernamePasswordCredentialsProvider("dingrundong","19961227+Drd");

        //克隆代码库命令
        CloneCommand cloneCommand = Git.cloneRepository();
        Git git= cloneCommand.setURI(remotePath) //设置远程URI
                .setBranch("main") //设置clone下来的分支
